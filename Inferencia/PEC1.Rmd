...
Nota.
- Aplica el siguiente código para poder replicar los resultados si los ejecutas 
varias veces,ya que si no fijas la semilla(seed) cada vez que ejecutes los 
comandos te dará un resultado diferente set.seed (unnumero)
- cambia “unnumero” por un número para que siempre genere la misma muestra. Así 
por ejemplo .x<-rnorm(10,mean=###, sd=####)
- genera una muestra de tamaño 10 con las medias y desviaciones típicas que 
sustituyas
```{r}
