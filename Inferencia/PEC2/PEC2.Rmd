...
Vamos a ver si hay asociación entre la variable cualitativa TAS (presión arterial sistólica) y la variable cualitativa ser caso o control. Realizaremos una tabla de contingencia y efectuaremos un contraste de independencia donde la Ho es que no existe relación entre las variables.
