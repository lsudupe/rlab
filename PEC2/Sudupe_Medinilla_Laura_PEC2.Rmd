...
```
En el resultado del "Call" se aprecian cuales seran los mejores predictores, calculamos de nuevo el modelo de regresión sobre estos
```{r}
#Modelo de regresión con los mejores predictores
rmr_epil_predictores <- lm(formula = data_epil$y ~ data_epil$trt + data_epil$base + data_epil$subject + 
