...
d) Calculad los residuos del modelo ajustado anterior y realizad un gráfico de
normalidad.
```{r}

```

e) De los apartados anteriores, ¿qué se puede concluir? No existe correlación 
directa entre las variables seleccionadas.
```{r}
