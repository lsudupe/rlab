...
Aunque se cumplan estan condiciones, vemos que no tiene porque existr una correlación alta entre las variables estudiadas. Para ver si podemos resolver parte del problema, realizaremos una regresión multivariante.
