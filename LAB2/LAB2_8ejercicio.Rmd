...
esperar • (C) Estimad el peso que tendrá una mujer que pese 168 cm. Podemos 
...
• (a) Determinad cuál es la variable dependiente y la variable independiente.
• (b) Mirad si existe relación y ajustad la recta de regresión en caso
afirmativo (utilizad todos los pasos usados en teoría).
